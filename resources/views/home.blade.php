@include('header')
    ...
    <!-- <div class="site-blocks-cover overlay" style="background-image: url(images/banner.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
            ...
            <div class="row mb-4">
              <div class="col-md-7">
                ...
                <div>
                  ...
                  <a href="#" class="btn btn-white py-3 px-5 rounded-0 d-block d-sm-inline-block">Contact Us</a>
                </div>
              </div>
            </div>
          </div>
...
<section id="banner" class="banner">
  <div id="owldemo1" class="owl-carousel owl-theme">
    <div class="item"> <img src="../assets/images/banner2.jpg" class="img-fluid">
      <div class="caption">
        <h2 class="display-4">Shop With Us</h2>
        <p class="mb-5 lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam assumenda ea quo cupiditate facere deleniti fuga officia.</p>
          <div>
              <a href="#" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 mb-lg-0 mb-2 d-block d-sm-inline-block">Shop Now</a>
              <a href="#" class="btn btn-white py-3 px-5 rounded-0 d-block d-sm-inline-block">Contact Us</a>
    ...
    <div class="item"> <img src="../assets/images/banner1.jpg" class="img-fluid">
      <div class="caption">
        <h2 class="display-4">Shop With Us</h2>
        <p class="mb-5 lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam assumenda ea quo cupiditate facere deleniti fuga officia.</p>
        <div>
    ...
    <div class="item"> <img src="../assets/images/banner3.jpg" class="img-fluid">
      <div class="caption">
        <h2 class="display-4">Shop With Us</h2>
        <p class="mb-5 lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam assumenda ea quo cupiditate facere deleniti fuga officia.</p>
        <div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
                  <span class="meta-icons mr-3"><a href="#" class="mr-2"><i class="fas fa-star text-warning"></i></a> 5.0</span>
                  <span class="meta-icons wishlist"><a href="#" class="mr-2"><i class="fas fa-heart"></i></a> 29</span>
                </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_2_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
                  <span class="meta-icons mr-3"><a href="#" class="mr-2"><i class="fas fa-star text-warning"></i></a> 5.0</span>
                  <span class="meta-icons wishlist active"><a href="#" class="mr-2"><i class="fas fa-heart"></i></a> 29</span>
                </div>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="#" class="btn btn-black mr-1 rounded-0">Cart</a>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_3_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_4_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_5_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/images/model_6_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
              <h3><a href="#">Latest Product</a></h3>
                <div class="mb-3">
        ...
        <div class="bg-white py-4">
          <div class="row mx-4 my-4 product-item-2 align-items-start">
            <div class="col-md-6 mb-5 mb-md-0 order-1 order-md-2">
              <img src="../assets/images/product_1_bg.jpg" alt="Image" class="img-fluid">
            </div>
        ...
        <div class="row align-items-lg-center">
          <div class="col-md-8 mb-5 mb-lg-0 position-relative">
            ...
            <div class="experience">
              <span class="year">Trusted Company</span>
    ...
    <div class="site-blocks-cover overlay get-notification aos-init aos-animate" id="special-section" style="background-image: url(images/hero_2.jpg); background-attachment: fixed; background-position: top;" data-aos="fade">
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 text-center py-5">
            ...
            <!-- <div id="date-countdown" class="mb-5"><span class="countdown-block"><span class="label">00</span> weeks </span><span class="countdown-block"><span class="label">00</span> days </span><span class="countdown-block"><span class="label">00</span> hr </span><span class="countdown-block"><span class="label">00</span> min </span><span class="countdown-block"><span class="label">00</span> sec</span></div> -->
        ...
        <div class="row align-items-stretch">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary fas fa-chart-pie"></i></div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary far fa-chart-bar"></i></div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary fab fa-twitch"></i></div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary fas fa-tags"></i></div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary fas fa-briefcase"></i></div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><i class="text-primary fas fa-cloud-download-alt"></i></div>
              <div>
          ...
          <div id="owldemo2" class="owl-carousel owl-theme">
            <div class="item">
              <div class="testimonial">
                ...
                <figure class="mb-4 d-block align-items-center justify-content-center">
                  <div><img src="../assets/images/person_1.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                </figure>
                ...
                <p class="text-black"><strong>Sandra Brown</strong></p>
            ...
            <div class="item">
              <div class="testimonial">
                ...
                <figure class="mb-4 d-block align-items-center justify-content-center">
                  <div><img src="../assets/images/person_2.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                </figure>
            ...
            <div class="item">
              <div class="testimonial">
                ...
                <figure class="mb-4 d-block align-items-center justify-content-center">
                  <div><img src="../assets/images/person_3.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                </figure>
                ...
                <p class="text-black"><strong>Markson Domoniz</strong></p>
